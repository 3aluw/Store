        ...
        <table class="table table-compact w-full">
            ...
            <tbody>
                <tr v-for="(item, index) in queryData" :key="item.uid">
                    ...
                    <td><button class="btn btn-circle btn-outline btn-sm hover:!bg-blue-600"
                            @click="toggleModal(index)"><svg width="20" height="20" viewBox="0 0 51 42" fill="none"
...
const modalProperties = [
    ...
    { name: "wilaya", value: "text" },
    { name: "orders number", value: "text" },
    { name: "total spent", value: "text" },
]
